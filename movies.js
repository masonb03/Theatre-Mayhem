...
function movieHTML(movie) {
    ...
    <div class="single__movie--info">
        ...
        <ul class="single__movie__misc--info">
            <li class="single__movie--fact"><b>Duration</b>: ${movie.Runtime}</li>
            <li class="single__movie--fact"><b>Rating</b>: ${movie.Rated}</li>
            <li class="single__movie--fact"><b>Released</b>: ${movie.Released}</li>
        </ul>
        <p class="single__movie--fact"><b>Genre:</b> ${movie.Genre}</p>
